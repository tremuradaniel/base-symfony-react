...
class CreateAdminConsoleCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            $this->createUserUseCase->execute($email, $password, ['ROLE_SUPER_ADMIN']);
            $io->success(sprintf('Superadmin user "%s" created successfully.', $email));
